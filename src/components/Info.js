  ...
  return (
    <section className="Info-container">
      <div className="Info-left">
        <h2>
          <span>ACTIVITIES</span> TO SUIT YOUR NEEDS
        </h2>
        <p>
          Challenging your body with different activities is the key to keeping
          the motivation and making your day more enjoyable.
        </p>
